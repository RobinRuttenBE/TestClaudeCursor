...
> - **Link CTR: 1,07%** (link_clicks ÷ impressions × 100)
> - **CPC (link): EUR 1,00** (spend ÷ link_clicks)
> - **Gem. dagspend: EUR 87,15 (9 actieve dagen)** over 9 actieve dagen (niet totaal/30)
> - Bron: spend EUR 784,32 · impressions 72.653 · link_clicks 781
> 
> **Per-ad link metrics (hardcoded):**
> 
...
|----|-------|-----|-----------|------|------|
| H11, B3, CTA5 (Kopie 1) | €328,99 | € 1,27 | 4 | n.v.t. (pixel datafout) | CPC boven target |
| H13, B3, CTA5 (Kopie 3) | €149,30 | € 1,05 | 2 | n.v.t. (pixel datafout) | CPC boven target |
...
2. **LP Conversie Rate is 1,0%** (? purchases (verifieer Wix) / 589 LPV), ruim onder de 5% target. Bottleneck zit op de landing page, niet in de ads.
...
**Goed nieuws:**
- ? purchases (verifieer Wix) (€1.473,50) uit €74,65 spend = ROAS n.v.t. (pixel datafout)
...
|----|----------|------------|------|--------|
| H11, B3, CTA5 | 1,02% | EUR 1,27 | **n.v.t. (pixel datafout)** | Core winner (? purchases (verifieer Wix)) |
| H12,B3,CTA5 | 1,10% | EUR 0,85 | n.v.t. (pixel datafout) | Emerging (te weinig data) |
| H13,B3,CTA5 | 1,12% | EUR 1,05 | n.v.t. (pixel datafout) | Emerging (monitor) |
