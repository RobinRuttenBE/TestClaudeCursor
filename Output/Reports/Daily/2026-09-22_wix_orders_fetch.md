...
**Vereiste actie:** Wix connector autoriseren via de claude.ai connector-instellingen, daarna de run herhalen. Dit is de vijfde opeenvolgende run (13, 17, 20, 21 en 22 sep) waarin dit faalde. Structurele oplossing: een Wix API key opslaan in een lokale .env en scripts/fetch-wix-orders.py de call rechtstreeks laten doen, zodat de morning report niet meer afhankelijk is van de MCP-autorisatie.
